<?php
/**
 * Plugin Name: 	WooCommerce registracija
 * Description:	    SJAUS ! Dodajte kod - [registracija] kako biste napravili registracionu formu
 * Version: 		1.0.0
 * Author: 			Radomir Popovic
 */
...
class WooCommerce_Simple_Registration {
	...
	public function __construct() {
		...
		add_shortcode( 'registracija', array( $this, 'registration_template' ) );
