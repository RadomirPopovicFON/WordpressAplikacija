...
<div id="payment" class="woocommerce-checkout-payment">
	...
	<div class="form-row place-order">
		<noscript>
			<?php _e( 'Ukoliko Vaš browser ne podržava JavaScript, ili je neomogućen, molimo Vas da kliknete na <em>Update Totals</em> dugme pre naručivanja. Može se desiti da bude naplaćeno više ukoliko ne odradite ovaj korak.', 'woocommerce' ); ?>
